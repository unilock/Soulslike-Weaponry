...
public class EntityModelLayerModRegistry {
    ...
    public static final EntityModelLayer NIGHTS_EDGE_LAYER = createMain("nights_edge");
    ...
    private static void registerBipedInnerArmor(EntityModelLayer layer) {
        EntityModelLayerRegistry.registerModelLayer(layer, () -> TexturedModelData.of(ArmorEntityModel.getModelData(HAT_DILATION), 64, 32));
    }
    private static void registerBipedOuterArmor(EntityModelLayer layer) {
        EntityModelLayerRegistry.registerModelLayer(layer, () -> TexturedModelData.of(ArmorEntityModel.getModelData(ARMOR_DILATION), 64, 32));
    }
}