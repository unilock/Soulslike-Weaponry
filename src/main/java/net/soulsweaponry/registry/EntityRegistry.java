...
public class EntityRegistry {
    ...
    public static final EntityType<WitheredDemon> WITHERED_DEMON = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "withered_demon"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, WitheredDemon::new).dimensions(EntityDimensions.fixed(1F, 2F)).build());
    public static final EntityType<AccursedLordBoss> ACCURSED_LORD_BOSS = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "accursed_lord_boss"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, AccursedLordBoss::new).dimensions(EntityDimensions.fixed(3F, 6F)).build());
    public static final EntityType<DraugrBoss> DRAUGR_BOSS = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "draugr_boss"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, DraugrBoss::new).dimensions(EntityDimensions.fixed(1.5F, 3F)).build());
    public static final EntityType<NightShade> NIGHT_SHADE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "night_shade"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, NightShade::new).dimensions(EntityDimensions.fixed(1.5F, 3.5F)).build());
    public static final EntityType<ReturningKnight> RETURNING_KNIGHT = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "returning_knight"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ReturningKnight::new).dimensions(EntityDimensions.fixed(3F, 8F)).build());
    public static final EntityType<Remnant> REMNANT = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "remnant"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, Remnant::new).dimensions(EntityDimensions.fixed(1F, 1.75F)).build());
    public static final EntityType<DarkSorcerer> DARK_SORCERER = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "dark_sorcerer"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, DarkSorcerer::new).dimensions(EntityDimensions.fixed(1F, 1.75F)).build());
    public static final EntityType<BigChungus> BIG_CHUNGUS = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "big_chungus"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, BigChungus::new).dimensions(EntityDimensions.fixed(0.75f, 0.75f)).build());
    public static final EntityType<SoulReaperGhost> SOUL_REAPER_GHOST = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "soul_reaper_ghost"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, SoulReaperGhost::new).dimensions(EntityDimensions.fixed(1F, 1.75F)).build());
    public static final EntityType<Forlorn> FORLORN = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "forlorn"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, Forlorn::new).dimensions(EntityDimensions.fixed(1F, 1.75F)).build());
    public static final EntityType<EvilForlorn> EVIL_FORLORN = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "evil_forlorn"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, EvilForlorn::new).dimensions(EntityDimensions.fixed(1F, 1.75F)).build());
    public static final EntityType<Soulmass> SOULMASS = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "soulmass"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, Soulmass::new).dimensions(EntityDimensions.fixed(2.7F, 3.5F)).build());
    public static final EntityType<ChaosMonarch> CHAOS_MONARCH = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "chaos_monarch"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ChaosMonarch::new).dimensions(EntityDimensions.fixed(2.5F, 6F)).build());
    public static final EntityType<Moonknight> MOONKNIGHT = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "moonknight"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, Moonknight::new).dimensions(EntityDimensions.fixed(3F, 8F)).build());
    public static final EntityType<FrostGiant> FROST_GIANT = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "frost_giant"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, FrostGiant::new).dimensions(EntityDimensions.fixed(1.25F, 2.6F)).build());
    public static final EntityType<RimeSpectre> RIME_SPECTRE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "rime_spectre"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, RimeSpectre::new).dimensions(EntityDimensions.fixed(1F, 2F)).build());
    ...
    public static final EntityType<DragonslayerSwordspearEntity> SWORDSPEAR_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "swordspear_entity"), FabricEntityTypeBuilder.<DragonslayerSwordspearEntity>create(SpawnGroup.MISC, DragonslayerSwordspearEntity::new).dimensions(EntityDimensions.fixed(1F, 1F)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<CometSpearEntity> COMET_SPEAR_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "comet_spear_entity"), FabricEntityTypeBuilder.<CometSpearEntity>create(SpawnGroup.MISC, CometSpearEntity::new).dimensions(EntityDimensions.fixed(1F, 1F)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<ChargedArrow> CHARGED_ARROW_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "charged_arrow_entity"), FabricEntityTypeBuilder.<ChargedArrow>create(SpawnGroup.MISC, ChargedArrow::new).dimensions(EntityDimensions.fixed(0.5f, 0.5f)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<SilverBulletEntity> SILVER_BULLET_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "silver_bullet_entity"), FabricEntityTypeBuilder.<SilverBulletEntity>create(SpawnGroup.MISC, SilverBulletEntity::new).dimensions(EntityDimensions.fixed(0.5F, 0.5F)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<Cannonball> CANNONBALL = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "cannonball_entity_type"), FabricEntityTypeBuilder.<Cannonball>create(SpawnGroup.MISC, Cannonball::new).dimensions(EntityDimensions.fixed(0.5F, 0.5F)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<LeviathanAxeEntity> LEVIATHAN_AXE_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "leviathan_axe_entity"), FabricEntityTypeBuilder.<LeviathanAxeEntity>create(SpawnGroup.MISC, LeviathanAxeEntity::new).dimensions(EntityDimensions.fixed(.5F, 1F)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<MjolnirProjectile> MJOLNIR_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "mjolnir_entity"), FabricEntityTypeBuilder.<MjolnirProjectile>create(SpawnGroup.MISC, MjolnirProjectile::new).dimensions(EntityDimensions.fixed(.75F, .75F)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<FreyrSwordEntity> FREYR_SWORD_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "freyr_sword_entity"), FabricEntityTypeBuilder.<FreyrSwordEntity>create(SpawnGroup.MISC, FreyrSwordEntity::new).dimensions(EntityDimensions.fixed(.3F, 2F)).build());
    public static final EntityType<ShadowOrb> SHADOW_ORB = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "shadow_orb_entity"), FabricEntityTypeBuilder.<ShadowOrb>create(SpawnGroup.MISC, ShadowOrb::new).dimensions(EntityDimensions.fixed(0.5F, 0.5F)).trackRangeChunks(4).trackedUpdateRate(30).build());
    ...
    public static final EntityType<DragonStaffProjectile> DRAGON_STAFF_PROJECTILE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "dragon_staff_projectile"), FabricEntityTypeBuilder.<DragonStaffProjectile>create(SpawnGroup.MISC, DragonStaffProjectile::new).dimensions(EntityDimensions.fixed(1F, 1F)).trackRangeChunks(4).trackedUpdateRate(10).build());
    public static final EntityType<WitheredWabbajackProjectile> WITHERED_WABBAJACK_PROJECTILE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "withered_wabbajack_projectile"), FabricEntityTypeBuilder.<WitheredWabbajackProjectile>create(SpawnGroup.MISC, WitheredWabbajackProjectile::new).dimensions(EntityDimensions.fixed(0.3125f, 0.3125f)).trackRangeChunks(4).trackedUpdateRate(10).build());
    public static final EntityType<ChaosSkull> CHAOS_SKULL = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "chaos_skull"), FabricEntityTypeBuilder.<ChaosSkull>create(SpawnGroup.MISC, ChaosSkull::new).dimensions(EntityDimensions.fixed(0.4f, 0.4f)).trackRangeChunks(4).trackedUpdateRate(10).build());
    public static final EntityType<ChaosOrbEntity> CHAOS_ORB_ENTITY = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "chaos_orb_entity"), FabricEntityTypeBuilder.<ChaosOrbEntity>create(SpawnGroup.MISC, ChaosOrbEntity::new).dimensions(EntityDimensions.fixed(0.5f, 0.5f)).trackRangeChunks(4).trackedUpdateRate(10).build());
    ...
    public static final EntityType<FogEntity> FOG_ENTITY = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "fog_entity"), FabricEntityTypeBuilder.<FogEntity>create(SpawnGroup.MISC, FogEntity::new).dimensions(EntityDimensions.changing(8f, 3f)).fireImmune().trackRangeChunks(4).trackedUpdateRate(Integer.MAX_VALUE).build());
    public static final EntityType<BlackflameSnakeEntity> BLACKFLAME_SNAKE_ENTITY = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "blackflame_snake_entity"), FabricEntityTypeBuilder.<BlackflameSnakeEntity>create(SpawnGroup.MISC, BlackflameSnakeEntity::new).dimensions(EntityDimensions.fixed(2f, 2f)).fireImmune().trackRangeChunks(4).trackedUpdateRate(Integer.MAX_VALUE).build());
    ...
    public static final EntityType<NightWaveEntity> NIGHT_WAVE = Registry.register(Registries.ENTITY_TYPE, Identifier.of(ModId, "night_wave"), FabricEntityTypeBuilder.<NightWaveEntity>create(SpawnGroup.MISC, NightWaveEntity::new).dimensions(EntityDimensions.fixed(3.5f, 1f)).fireImmune().trackRangeChunks(4).trackedUpdateRate(Integer.MAX_VALUE).build());
