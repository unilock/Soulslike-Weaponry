...
public class WeaponRegistry {
    ...
    public static DetonateGroundItem DARKIN_BLADE = new DarkinBlade(ModToolMaterials.CRIMSON_INGOT, new Item.Settings().rarity(Rarity.EPIC));
    ...
    public static ToolItem GUTS_SWORD = new DragonslayerSwordBerserk(ModToolMaterials.IRON_BLOCK, new Item.Settings().rarity(Rarity.EPIC));
    ...
    public static ToolItem FORLORN_SCYTHE = new ForlornScythe(ModToolMaterials.LOST_SOUL, new Item.Settings().rarity(Rarity.UNCOMMON));
    ...
    public static TrickWeapon KIRKHAMMER = new TrickWeapon(ModToolMaterials.IRON_BLOCK, 0, new Item.Settings().rarity(Rarity.RARE), 1, 0, true, false);
    public static TrickWeapon SILVER_SWORD = new TrickWeapon(ModToolMaterials.IRON_BLOCK, 1, new Item.Settings().rarity(Rarity.RARE), 0, 1, false, true);
    public static TrickWeapon HOLY_GREATSWORD = new TrickWeapon(ModToolMaterials.IRON_BLOCK, 2, new Item.Settings().rarity(Rarity.RARE), 1, 2, false, true);
    ...
    public static HolyMoonlightGreatsword HOLY_MOONLIGHT_GREATSWORD = new HolyMoonlightGreatsword(ModToolMaterials.MOONSTONE_OR_VERGLAS,  new Item.Settings().rarity(Rarity.EPIC), 4);
    ...
    public static BowItem KRAKEN_SLAYER = new KrakenSlayer(new Item.Settings().maxDamage(1258).rarity(Rarity.EPIC));
    public static CrossbowItem KRAKEN_SLAYER_CROSSBOW = new KrakenSlayerCrossbow(new Item.Settings().maxDamage(1258).rarity(Rarity.EPIC));
    public static BowItem DARKMOON_LONGBOW = new DarkmoonLongbow(new Item.Settings().maxDamage(1400).rarity(Rarity.EPIC));
