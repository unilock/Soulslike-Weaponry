...
public class WeaponRegistry {
    ...
    public static CrossbowItem KRAKEN_SLAYER_CROSSBOW = new KrakenSlayerCrossbow(new FabricItemSettings().maxDamage(1258).rarity(Rarity.EPIC));
    public static BowItem DARKMOON_LONGBOW = new DarkmoonLongbow(new FabricItemSettings().maxDamage(1400).rarity(Rarity.EPIC));
